...
namespace GDHOTE.Hub.PortalCore.Services
{
    public class PortalMemberDetailsService
    {
        ...
        public static MemberDetails GetMemberDetails(string id)
        {
        ...
        public static Response CreateMemberDetails(CreateMemberDetailsRequest createRequest)
        {
        ...
        public static Response UpdateMemberDetails(UpdateMemberDetailsRequest updateRequest)
        {
        ...
        public static Response DeleteMemberDetails(string id)
        {
