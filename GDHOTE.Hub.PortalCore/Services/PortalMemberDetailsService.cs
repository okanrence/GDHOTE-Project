...
namespace GDHOTE.Hub.PortalCore.Services
{
    ...
    {
        public static List<MemberDetailsViewModel> GetMembersDetails(Token token)
        {
        ...
        public static MemberDetails GetMemberDetails(string id, Token token)
        {
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<MemberDetails>(response.Content);
            }
            catch (Exception ex)
            {
                ErrorLogManager.LogError(MethodBase.GetCurrentMethod().Name, ex);
        ...
        public static Response CreateMemberDetails(CreateMemberDetailsRequest createRequest, Token token)
        {
            var requestData = JsonConvert.SerializeObject(createRequest);
            string fullUrl = ConfigService.ReturnBaseUrl() + "/member/create-member-details";
            var client = new RestClient(fullUrl);
        ...
        public static Response UpdateMemberDetails(UpdateMemberDetailsRequest updateRequest, Token token)
        {
            var requestData = JsonConvert.SerializeObject(updateRequest);
            string fullUrl = ConfigService.ReturnBaseUrl() + "/member/update-member-details";
            var client = new RestClient(fullUrl);
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddHeader("Authorization", "Bearer " + token.AuthToken);
        ...
        public static Response DeleteMemberDetails(string id, Token token)
        {

            string fullUrl = ConfigService.ReturnBaseUrl() + "/member/delete-member-details";
            var client = new RestClient(fullUrl);
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddHeader("Authorization", "Bearer " + token.AuthToken);
