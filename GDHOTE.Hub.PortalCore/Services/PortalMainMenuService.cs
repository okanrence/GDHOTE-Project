    ...
    public class PortalMainMenuService
    {
        public static List<MainMenuViewModel> GetMainMenus()
        {
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<List<MainMenuViewModel>>(response.Content);
            }
            catch (Exception ex)
            {
                //ErrorLogManager.LogError(callerFormName, computerDetails, "DoMainMenu", ex);
            }
            return result;
        }
        ...
        public static MainMenu GetMainMenu(string id)
        {
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<MainMenu>(response.Content);
            }
            catch (Exception ex)
            {
                //ErrorLogManager.LogError(callerFormName, computerDetails, "DoMainMenu", ex);
