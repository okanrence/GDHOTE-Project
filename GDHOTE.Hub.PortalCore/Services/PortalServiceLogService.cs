...
{
  public  class PortalServiceLogService
    {
        public static Response CreateServiceLog(CreateServiceLogRequest createRequest, Token token)
        {
            var requestData = JsonConvert.SerializeObject(createRequest);
            string fullUrl = ConfigService.ReturnBaseUrl() + "/service/create-service-log";
