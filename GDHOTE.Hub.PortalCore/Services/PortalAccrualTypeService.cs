...
namespace GDHOTE.Hub.PortalCore.Services
{
    ...
    {
        public static List<AccrualTypeViewModel> GetAllAccrualTypes(Token token)
        {
        ...
        public static List<AccrualTypeResponse> GetActiveAccrualTypes(Token token)
        {
        ...
        public static AccrualType GetAccrualType(string id, Token token)
        {
        ...
        public static Response CreateAccrualType(CreateAccrualTypeRequest createRequest, Token token)
        {
        ...
        public static Response UpdateAccrualType(UpdateAccrualTypeRequest updateRequest, Token token)
        {
            var requestData = JsonConvert.SerializeObject(updateRequest);
            string fullUrl = ConfigService.ReturnBaseUrl() + "/accrual/update-accrual-type";
            var client = new RestClient(fullUrl);
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddHeader("Authorization", "Bearer " + token.AuthToken);
        ...
        public static Response DeleteAccrualType(string id, Token token)
        {
